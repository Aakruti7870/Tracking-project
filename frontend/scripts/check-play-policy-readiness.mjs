...
expect(expo.version === '1.1.0', 'Expo version must be 1.1.0 for vc90.');
expect(android.versionCode === 90, 'Android versionCode must be 90.');
...
if(process.exitCode) process.exit(process.exitCode); console.log('Google Play policy readiness assertions passed for TrackMyRMC v1.1.0 / vc90.');
