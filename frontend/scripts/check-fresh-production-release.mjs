...
requireInvariant(app.expo.version === '2.0.30', 'Expected Expo version 2.0.30');
requireInvariant(app.expo.android?.versionCode === 88, 'Expected Android versionCode 88');
...
requireInvariant(
  releaseWorkflow.includes("android:versionCode=\"88\"") && releaseWorkflow.includes("android:versionName=\"2.0.30\""),
  'Signed AAB workflow must validate vc88 / v2.0.30',
);
requireInvariant(
