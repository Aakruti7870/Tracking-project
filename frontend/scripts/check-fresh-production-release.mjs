...
requireInvariant(app.expo.version === '2.0.26', 'Expected Expo version 2.0.26');
requireInvariant(app.expo.android?.versionCode === 84, 'Expected Android versionCode 84');
...
requireInvariant(
  releaseWorkflow.includes("android:versionCode=\"84\"") && releaseWorkflow.includes("android:versionName=\"2.0.26\""),
  'Signed AAB workflow must validate vc84 / v2.0.26',
);
requireInvariant(
